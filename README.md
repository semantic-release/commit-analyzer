...
| `isInitialPhase` | Indicates that the application is still in the initial development phase as described in the SemVer documentation [here](https://semver.org/#spec-item-4). Therefore, its public API is considered unstable and the major version will be kept at `0.y.z` pattern. | `false` |
