...
const setInitialPhaseRelease = require('./set-initial-phase-release');
 ...
 */
module.exports = (releaseRules, commit, isInitialPhase) => {
  let releaseType;
  ...
  return setInitialPhaseRelease(releaseType, isInitialPhase);
};
